...
public class Pebble2HeartRateFiltered extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Pebble2HeartRateFiltered\",\"namespace\":\"org.radarcns.pebble2\",\"doc\":\"Filtered and smoothed heart rate from the Pebble 2 Heart Monitor. You can compute the inter beat interval rate as (60 / heartRate).\",\"fields\":[{\"name\":\"time\",\"type\":\"double\",\"doc\":\"device timestamp in UTC (s)\"},{\"name\":\"timeReceived\",\"type\":\"double\",\"doc\":\"device receiver timestamp in UTC (s)\"},{\"name\":\"heartRate\",\"type\":\"float\",\"doc\":\"heart rate (bpm)\"}]}");
  ...
  public static org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder newBuilder() {
    return new org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder();
  }
  
  /** Creates a new Pebble2HeartRateFiltered RecordBuilder by copying an existing Builder */
  public static org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder newBuilder(org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder other) {
    return new org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder(other);
  }
  
  /** Creates a new Pebble2HeartRateFiltered RecordBuilder by copying an existing Pebble2HeartRateFiltered instance */
  public static org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder newBuilder(org.radarcns.pebble2.Pebble2HeartRateFiltered other) {
    return new org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Pebble2HeartRateFiltered>
    ...
    private Builder() {
      super(org.radarcns.pebble2.Pebble2HeartRateFiltered.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder other) {
      super(other);
    ...
    private Builder(org.radarcns.pebble2.Pebble2HeartRateFiltered other) {
            super(org.radarcns.pebble2.Pebble2HeartRateFiltered.SCHEMA$);
      if (isValidValue(fields()[0], other.time)) {
        this.time = data().deepCopy(fields()[0].schema(), other.time);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'time' field */
    public org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder setTime(double value) {
    ...
    public org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder clearTime() {
    ...
    /** Sets the value of the 'timeReceived' field */
    public org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder setTimeReceived(double value) {
    ...
    public org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder clearTimeReceived() {
    ...
    /** Sets the value of the 'heartRate' field */
    public org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder setHeartRate(float value) {
    ...
    public org.radarcns.pebble2.Pebble2HeartRateFiltered.Builder clearHeartRate() {
