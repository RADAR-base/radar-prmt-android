...
public class PhoneBatteryLevel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2065940568097639030L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PhoneBatteryLevel\",\"namespace\":\"org.radarcns.phone\",\"doc\":\"Phone battery level.\",\"fields\":[{\"name\":\"time\",\"type\":\"double\",\"doc\":\"device timestamp in UTC (s)\"},{\"name\":\"timeReceived\",\"type\":\"double\",\"doc\":\"device receiver timestamp in UTC (s)\"},{\"name\":\"batteryLevel\",\"type\":\"float\",\"doc\":\"battery level from 0 to 1\"}]}");
   ...
   */
  public PhoneBatteryLevel(java.lang.Double time, java.lang.Double timeReceived, java.lang.Float batteryLevel) {
    this.time = time;
  ...
  /**
   * Creates a new PhoneBatteryLevel RecordBuilder.
   * @return A new PhoneBatteryLevel RecordBuilder
   */
  public static org.radarcns.phone.PhoneBatteryLevel.Builder newBuilder() {
    return new org.radarcns.phone.PhoneBatteryLevel.Builder();
  }

  /**
   * Creates a new PhoneBatteryLevel RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new PhoneBatteryLevel RecordBuilder
   */
  public static org.radarcns.phone.PhoneBatteryLevel.Builder newBuilder(org.radarcns.phone.PhoneBatteryLevel.Builder other) {
    return new org.radarcns.phone.PhoneBatteryLevel.Builder(other);
  }

  /**
   * Creates a new PhoneBatteryLevel RecordBuilder by copying an existing PhoneBatteryLevel instance.
   * @param other The existing instance to copy.
   * @return A new PhoneBatteryLevel RecordBuilder
   */
  public static org.radarcns.phone.PhoneBatteryLevel.Builder newBuilder(org.radarcns.phone.PhoneBatteryLevel other) {
    return new org.radarcns.phone.PhoneBatteryLevel.Builder(other);
  }

  /**
   * RecordBuilder for PhoneBatteryLevel instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneBatteryLevel>
    implements org.apache.avro.data.RecordBuilder<PhoneBatteryLevel> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.radarcns.phone.PhoneBatteryLevel.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing PhoneBatteryLevel instance
     * @param other The existing instance to copy.
     */
    private Builder(org.radarcns.phone.PhoneBatteryLevel other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.time)) {
        this.time = data().deepCopy(fields()[0].schema(), other.time);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.phone.PhoneBatteryLevel.Builder setTime(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.phone.PhoneBatteryLevel.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.phone.PhoneBatteryLevel.Builder setTimeReceived(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.phone.PhoneBatteryLevel.Builder clearTimeReceived() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.phone.PhoneBatteryLevel.Builder setBatteryLevel(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.phone.PhoneBatteryLevel.Builder clearBatteryLevel() {
