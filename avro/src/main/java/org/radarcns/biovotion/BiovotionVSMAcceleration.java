...
public class BiovotionVSMAcceleration extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1356841073096658686L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BiovotionVSMAcceleration\",\"namespace\":\"org.radarcns.biovotion\",\"doc\":\"Data from 3-axis accelerometer sensor with gravitational constant g as unit.\",\"fields\":[{\"name\":\"time\",\"type\":\"double\",\"doc\":\"device timestamp in UTC (s)\"},{\"name\":\"timeReceived\",\"type\":\"double\",\"doc\":\"device receiver timestamp in UTC (s)\"},{\"name\":\"x\",\"type\":\"float\",\"doc\":\"acceleration in the x-axis (g)\"},{\"name\":\"y\",\"type\":\"float\",\"doc\":\"acceleration in the y-axis (g)\"},{\"name\":\"z\",\"type\":\"float\",\"doc\":\"acceleration in the z-axis (g)\"}]}");
   ...
   */
  public BiovotionVSMAcceleration() {}
   ...
   */
  public BiovotionVSMAcceleration(java.lang.Double time, java.lang.Double timeReceived, java.lang.Float x, java.lang.Float y, java.lang.Float z) {
    this.time = time;
  ...
  /**
   * Creates a new BiovotionVSMAcceleration RecordBuilder.
   * @return A new BiovotionVSMAcceleration RecordBuilder
   */
  public static org.radarcns.biovotion.BiovotionVSMAcceleration.Builder newBuilder() {
    return new org.radarcns.biovotion.BiovotionVSMAcceleration.Builder();
  }

  /**
   * Creates a new BiovotionVSMAcceleration RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new BiovotionVSMAcceleration RecordBuilder
   */
  public static org.radarcns.biovotion.BiovotionVSMAcceleration.Builder newBuilder(org.radarcns.biovotion.BiovotionVSMAcceleration.Builder other) {
    return new org.radarcns.biovotion.BiovotionVSMAcceleration.Builder(other);
  }

  /**
   * Creates a new BiovotionVSMAcceleration RecordBuilder by copying an existing BiovotionVSMAcceleration instance.
   * @param other The existing instance to copy.
   * @return A new BiovotionVSMAcceleration RecordBuilder
   */
  public static org.radarcns.biovotion.BiovotionVSMAcceleration.Builder newBuilder(org.radarcns.biovotion.BiovotionVSMAcceleration other) {
    return new org.radarcns.biovotion.BiovotionVSMAcceleration.Builder(other);
  }

  /**
   * RecordBuilder for BiovotionVSMAcceleration instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BiovotionVSMAcceleration>
    implements org.apache.avro.data.RecordBuilder<BiovotionVSMAcceleration> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.radarcns.biovotion.BiovotionVSMAcceleration.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing BiovotionVSMAcceleration instance
     * @param other The existing instance to copy.
     */
    private Builder(org.radarcns.biovotion.BiovotionVSMAcceleration other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.time)) {
        this.time = data().deepCopy(fields()[0].schema(), other.time);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder setTime(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder setTimeReceived(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder clearTimeReceived() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder setX(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder clearX() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder setY(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder clearY() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder setZ(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.radarcns.biovotion.BiovotionVSMAcceleration.Builder clearZ() {
      fieldSetFlags()[4] = false;
      return this;
    }

    @Override
    public BiovotionVSMAcceleration build() {
      try {
        BiovotionVSMAcceleration record = new BiovotionVSMAcceleration();
