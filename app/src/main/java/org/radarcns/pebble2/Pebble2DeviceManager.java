...
class Pebble2DeviceManager implements EmpaDataDelegate, EmpaStatusDelegate, DeviceManager {
    ...
    public Pebble2DeviceManager(Context context, DeviceStatusListener e4Service, String apiKey, String groupId, TableDataHandler dataHandler, E4Topics topics) {
    ...
    public void start(@NonNull final Set<String> acceptableIds) {
        ...
        getHandler().post(new Runnable() {
            ...
            public void run() {
                ...
                deviceManager = new EmpaDeviceManager(context, Pebble2DeviceManager.this, Pebble2DeviceManager.this);
                // Initialize the Device Manager using your API key. You need to have Internet access at this point.
                deviceManager.authenticateWithAPIKey(apiKey);

                Pebble2DeviceManager.this.acceptableIds = new HashSet<>();
                for (String s : acceptableIds) {
                    Pebble2DeviceManager.this.acceptableIds.add(s.toLowerCase());
                }
